...
5. **Auto-Update Server**: To allow the phone to check for updates while connected via USB, run `python3 src/signal_tester/update_server.py`. The `deploy_to_phone.sh` script handles the necessary `adb reverse` port forwarding.
